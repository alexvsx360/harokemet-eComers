...
<body>
  <header>
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand  col-sm-3 col-md-2 mr-0" href="<?php echo e(url(' ')); ?>"><img src="<?php echo e(asset('img/tmpimg/logo.png')); ?>"
          class="bg-light rounded-circle h-25 w-25 creator-image" alt=""> Harokemet</a>
      <ul class="nav px-3">
        <li class="nav-item ">
          <a target="_blank" class="nav-link text-white" href="<?php echo e(url('')); ?>">Front site</a>
        </li>
        <li class="nav-item ">
      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('cms/massage')); ?>">
                <span data-feather="file"></span>
                Client Massages
              </a>
            </li>
...
</html><?php /**PATH /Applications/MAMP/htdocs/harokemet/resources/views/cms/cms_master.blade.php ENDPATH**/ ?>