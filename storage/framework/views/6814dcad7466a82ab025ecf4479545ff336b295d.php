...
<div class="container ">
    ...
    <header class=" parallax" style="background-image: url('<?php echo e(asset('img/'.$products[0]->cimage)); ?>');">
        <div class="header-content dark text-center">
            ...
            <p class="inner-space mb-0 text-dark">Harokemet Shop Products</p>
        </div><!-- / header-content -->
    </header>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/eShop/resources/views/site/content/products.blade.php ENDPATH**/ ?>