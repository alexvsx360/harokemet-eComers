    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 text-center fact-item">
                ...
                <h3 class="timer" id="photos" data-to="2432" data-speed="3000"><?php echo e($a); ?></h3>
            ...
            <div class="col-md-6 col-lg-3 text-center fact-item">
                ...
                <h3 class="timer" id="paintings" data-to="1547" data-speed="4000"><?php echo e($z); ?></h3>
            ...
            <div class="col-md-6 col-lg-3 text-center fact-item">
                ...
                <h3 class="timer" id="art" data-to="3697" data-speed="5000"><?php echo e($x); ?></h3>
            ...
            <div class="col-md-6 col-lg-3 text-center fact-item">
                ...
                <h3 class="timer" id="deliveries" data-to="2754" data-speed="6000"><?php echo e($y); ?></h3>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="team block image-block text-center">
                    <img style="height: 350px !important" src="<?php echo e(asset('img/ANNA.jpg')); ?>" alt="">
            ...
            <div class="col-md-4">
                <div class="team block image-block text-center">
                    <img style="height: 350px !important" src="<?php echo e(asset('img/ALEXANDER.jpg')); ?>" alt="">
                    <div class="team-content inner-space bg-white">
            ...
            <div class="col-md-4">
                <div class="team block image-block text-center">
                    <img style="height: 350px !important" src="<?php echo e(asset('img/sherlok.jpeg')); ?>" alt="">
                    <div class="team-content inner-space bg-white">
...
<?php echo $__env->make('site.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/harokemet/resources/views/site/content/welcome.blade.php ENDPATH**/ ?>